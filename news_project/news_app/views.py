...
#     local_news = News.published.all().filter(category__name='Mahalliy').order_by('-publish_time')[1:10]
#     context = {
#         'news_list': news_list,
...
class HomePageVie(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['texnologiya_xabarlari'] = News.published.all().filter(category__name='Texnologiya').order_by('-publish_time')[:10]
        return context
